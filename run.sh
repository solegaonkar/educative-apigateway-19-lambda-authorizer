...
# -----------------------------------------------------------------
# Invoke the URL without token to test the response
# -----------------------------------------------------------------
curl --location --request GET $url --header 'Content-Type: application/json' --data-raw '{"message": "Hello World"}'

# -----------------------------------------------------------------
# Invoke the URL with token to test the response
# -----------------------------------------------------------------
curl --location --request GET $url --header 'Authorization: token' --header 'Content-Type: application/json' --data-raw '{"message": "Hello World"}'
